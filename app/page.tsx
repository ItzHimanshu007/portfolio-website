  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 container mx-auto p-3 sm:p-4 pt-20 sm:pt-24 pb-6 sm:pb-8">
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <AnimatedSection animation="slide-right" delay={500}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">AI & ML</h4>
                        <div className="flex flex-wrap gap-2">
                          {technicalSkills.aiAndMl?.map((skill, index) => (
                            <SkillTagComponent key={index}>{skill}</SkillTagComponent>
                          ))}
                        </div>
                      </div>
        ...
        >
          <p>© {new Date().getFullYear()} Himanshu Jasoriya. All rights reserved.</p>
        </AnimatedSection>
      </div>
